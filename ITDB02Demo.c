/**********************************************************
This code show you how to use the STC 8051 to control the
ITDB02 LCD module display.
...
#define Bus_16  //16bit Mode ,if you use the 8bit mode , don't define it.  
#define  LCD_DataPortH P2  // High 8 bit,it will be used in 8 bit mode
#define  LCD_DataPortL P0  // Low 8 bit , it will not be uesd in 8 bit mode
sbit LCD_RS = P3^5;  	// data and command switch
sbit LCD_WR = P3^6;		 //Write control
sbit LCD_RD =P3^7;		//Read control
sbit LCD_CS=P1^0;		//chip select
sbit LCD_REST = P1^2;	 //reset
