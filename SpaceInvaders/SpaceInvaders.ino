...
int buttonPinRIGHT= 11;
int buttonPinBUTTON = 10;
...
boolean getInput() {
  ...
  if ( analogRead( joyleftright ) < 500  && (cannonX > 0)) {
    oldCannonX = cannonX;
    cannonXF--;
    ...
    if (  analogRead( joyleftright ) > 600 && (cannonX < (W-CANNON_WIDTH))) {
      oldCannonX = cannonX;
      cannonXF++;
      cannonX = (cannonXF + 5) / 100;
      if (oldCannonX != cannonX) {
